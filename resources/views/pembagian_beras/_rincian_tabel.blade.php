    ...
    <table class="min-w-full text-sm mb-4 sorting-group-table" data-sorting-number="{{ $sorting }}">
        <thead>
                    ...
                    <div class="flex items-center justify-between">
                        <span class="flex items-center gap-2">
                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002-2h2a2 0 002-2"></path>
                            </svg>
            ...
            <tr class="bg-slate-50">
                ...
                <th class="border-b border-slate-200 px-2 py-3 text-center font-semibold text-slate-700 w-20">Status</th>
            </tr>
        </thead>
        <tbody>
