...
<head>
    ...
    <title>Print - Bahan Baku Beras</title>
    <style>
            ...
            <div class="container">
                <table class="print-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="col-left">
                                H: Rp {{ number_format($beras->harga, 0, ',', '.') }}
                            </td>
                            <td class="col-mid" rowspan="{{ $totalRows }}">
                                <div class="col-mid-inner">{{ $beras->catatan_cek }}</div>
                            </td>
                            <td class="col-right {{ $beras->harga_rata > 0 ? 'highlight-yellow' : '' }}">
                                R: Rp {{ $beras->harga_rata > 0 ? number_format($beras->harga_rata, 0, ',', '.') : '' }}
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td class="col-left">{{ $beras->supplier }}</td>
                            <td class="col-right">{{ $beras->lokasi_penyimpanan }}</td>
                        </tr>
